...
type SidebarProps = {
  sessionMember: Participant | undefined;
...
export const Sidebar = ({
  ...
  const { isOpen, close } = useMobileMenuOpen();
    ...
    >
        ...
        <div className="space-y-4 mb-10 overflow-y-auto pr-2">
          {staff.map((member) => (
            <div
              ...
              onClick={() => {
                if (isStaff) {
                  router.push(`/torneios/${tournament.id}/user/${member.id}`);
                }
              }}
      ...
      <div className="p-6 border-t border-zinc-900 bg-[#0a0a0a] mt-auto italic">
        ...
        {sessionMember ? (
          ...
          <p className="text-[9px] flex flex-col gap-5 text-zinc-700 text-center font-black mb-4 uppercase">
