    ...
    <div className="animate-in slide-in-from-bottom-4 duration-500">
      {isRandomizing && (
        <div className="py-20 sm:py-32 text-center bg-[#111] border border-zinc-800 relative overflow-hidden uppercase italic tracking-widest">
          ...
          <div className="w-12 h-12 sm:w-16 sm:h-16 border-4 border-primary border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>
          <h4 className="text-2xl sm:text-3xl font-black italic tracking-tighter text-primary">
            PROCESSANDO SORTEIO
          </h4>
